...
class TestSoundMethods(unittest.TestCase):
    ...
    def test_frames(self):
        fail_message = "The center from the frames generator and the center computed by frametimes are not equal!"
        for _ in range(100):
            ...
            for window, center in zip(windows, window_centers):
                ...
                self.assertAlmostEqual(center1, center2, 3, fail_message)
